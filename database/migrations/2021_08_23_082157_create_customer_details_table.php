...
class CreateCustomerDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('customer_details', function (Blueprint $table) {
            ...
            $table->longText('business_country_id');
            $table->longText('business_city_id');
            $table->longText('business_region_id');
            ...
            $table->longText('delivery_country_id');
            $table->longText('delivery_city_id');
            $table->longText('delivery_region_id');
