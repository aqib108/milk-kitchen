...
<body>
    @php $total =0;@endphp
            ...
            <div class="row mb-40-wrapper">
                <div class="col-lg-12">
                    <h2 class="heading-tbl" style="margin-left: 10px;">Run Picklist</h2>
                </div>
                <div class="col-lg-12 mt-5">
                <h6 class="heading-tbl" style="margin-left: 10px;">  <b>Run:</b>   {{$zone}}</h6>
                    <h6 class="heading-tbl" style="margin-left: 10px;"> <b>Delivery Date And Day :</b>       ({{date('l')}}  {{date('Y-m-d')}})</h6>
                </div>
                    ...
                    <div class="table-responsive" style="width: 100%">
                        ...
                        <thead>
                                        <tr>
                                            ...
                                            <th class="table-th-wrapper" scope="col">Provisioned</th>
                                            <th class="table-th-wrapper" scope="col">Received</th>
                                        </tr>
                                    </thead>
                                    <tbody class="week-container-tbl">
                                        @foreach ($products as $product1)
                                        <tr class="week_days_1">
                                            <td class="table-td-wrapper" scope="row" style="background-color: white !important; width: 275px; text-align:center;">
                                                {{ $product1['name'] }}
                                            </td>
                                            <td style="background-color: white !important; width: 275px; text-align:center;">
                                                <div class="quantity">
                                                    {{ $product1['carton'] }}
                                                </div>
                                            ...
                                            <td style="background-color: white !important; width: 275px; text-align:center;"></td>
                                            <td style="background-color: white !important; width: 275px; text-align:center;"></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
