...
$customer = App\Models\CustomerDetail::whereUserId($id)->get();
$total=0;
@endphp
...
>>>>>>> a3954e1cb612b4f95a76db7342f9d78afa949dda
                </div>
            </section>
            <!--  -->
            <section  style="padding:0px !important;">
...
<<<<<<< HEAD
    ...
    <div class="row mb-40-wrapper">
        <div class="col-lg-12">
            <h2 class="heading-tbl" style="margin-left: 50px;">Delivery Items</h2>
        </div>
        <div class="col-lg-4">
