                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" maxlength="50" class="form-control" name="name" id="firstName"  placeholder="Enter Name">
                                    <div class="alert alert-danger" id="first-name-err"></div>
                                </div>
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    <label>Email <span class="required-star">*</span></label>
                                    <input type="text" class="form-control" name="email" id="emailAddress" placeholder="Enter Email Number">
                                    <div class="alert alert-danger" id="email-err"></div>
                                </div>
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    <label>Phone <span class="required-star">*</span></label>
                                    <input type="number" class="form-control @error('phone') is-invalid @enderror" name="phone" id="mobileNumber" maxlength="17" value="{{old('phone')}}" placeholder="Enter Phone Number">
